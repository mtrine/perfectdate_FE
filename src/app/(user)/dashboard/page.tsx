  ...
  return (
    <div>
      <div className=" flex flex-col justify-center pt-20 max-w-[70%] mx-auto h-screen space-y-[5%] ">
        {planList ? <HavePlan data={planList} /> : <NotHavePlan />}
      </div>
      <button
        className="absolute bottom-2 right-3 w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 bg-darkRed text-cream rounded-full flex items-center justify-center shadow-lg hover:bg-lightRed transition duration-300"
        onClick={() => {
